...
@section('content')
    ...
    <table class="table table-hover table-striped" align="center">
        ...
        <tr>
            ...
            <td><b>Fecha de la Evaluación: {!! date('d/m/Y',strtotime($preguntas[0]->fecha_reg)) !!}</b></td>
        </tr>
        <tr>
            <td><b>Dependencia / Organismo Auxiliar: {{$unidades->depen_desc}}</b></td>
            <td></td>
        </tr>
        <tr>
            <td><b>Nombre del Titular de la Dependencia / Organismo Auxiliar: {{$proceso[0]->responsable}}</b></td>
            <td></td>
        </tr>
        <tr>
